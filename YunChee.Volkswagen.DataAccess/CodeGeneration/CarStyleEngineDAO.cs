...
{
    /// <summary>
    /// 数据访问： 0307车款发动机表 CarStyleEngine 
    /// 表CarStyleEngine的数据访问类     
    /// 1.实现ICRUDable接口
    /// 2.实现IQueryable接口
    /// 3.实现Load方法
    /// </summary>
    public partial class CarStyleEngineDAO : BaseDAO<BasicUserInfo>, ICRUDable<CarStyleEngineEntity>, IQueryable<CarStyleEngineEntity>
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public CarStyleEngineDAO(BasicUserInfo pUserInfo)
        ...
        public void Create(CarStyleEngineEntity pEntity)
        {
        ...
        public void Create(CarStyleEngineEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
            ...
            strSql.Append("insert into [CarStyleEngine](");
            strSql.Append("[CarStyleID],[CreateBy],[CreateTime],[LastUpdateBy],[LastUpdateTime],[IsDelete],[Column1],[Column2],[Column3],[Column4],[Column5],[Column6],[Column7],[Column8],[Column9],[Column10],[Column11],[Column12],[Column13],[Column14],[Column15],[Column16],[Column17],[Column18],[Column19],[Column20],[Column21],[Column22],[Column23],[Column24],[Column25],[Column26],[Column27],[Column28],[Column29],[Column30])");
            ...
            SqlParameter[] parameters = 
            {
					...
					new SqlParameter("@Column26",SqlDbType.NVarChar),
					new SqlParameter("@Column27",SqlDbType.NVarChar),
					new SqlParameter("@Column28",SqlDbType.NVarChar),
					new SqlParameter("@Column29",SqlDbType.NVarChar),
					new SqlParameter("@Column30",SqlDbType.NVarChar)
            };
			...
			parameters[31].Value = pEntity.Column26;
			parameters[32].Value = pEntity.Column27;
			parameters[33].Value = pEntity.Column28;
			parameters[34].Value = pEntity.Column29;
			parameters[35].Value = pEntity.Column30;
        ...
        public CarStyleEngineEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
            ...
            sql.AppendFormat("select * from [CarStyleEngine] where ID='{0}' and IsDelete=0 ", id.ToString());
            //读取数据
            CarStyleEngineEntity m = null;
        ...
        /// </summary>
        /// <returns></returns>
        public CarStyleEngineEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [CarStyleEngine] where isdelete=0");
            //读取数据
            List<CarStyleEngineEntity> list = new List<CarStyleEngineEntity>();
            using (SqlDataReader rdr = this.SQLHelper.ExecuteReader(sql.ToString()))
            {
                while (rdr.Read())
                {
                    CarStyleEngineEntity m;
                    this.Load(rdr, out m);
                    list.Add(m);
                }
            }
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(CarStyleEngineEntity pEntity , IDbTransaction pTran)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(CarStyleEngineEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            ...
            //组织参数化SQL
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [CarStyleEngine] set ");
            ...
            if (pIsUpdateNullField || pEntity.Column26!=null)
                strSql.Append( "[Column26]=@Column26,");
            if (pIsUpdateNullField || pEntity.Column27!=null)
                strSql.Append( "[Column27]=@Column27,");
            if (pIsUpdateNullField || pEntity.Column28!=null)
                strSql.Append( "[Column28]=@Column28,");
            if (pIsUpdateNullField || pEntity.Column29!=null)
                strSql.Append( "[Column29]=@Column29,");
            if (pIsUpdateNullField || pEntity.Column30!=null)
                strSql.Append( "[Column30]=@Column30");
			...
			parameters[28].Value = pEntity.Column26;
			parameters[29].Value = pEntity.Column27;
			parameters[30].Value = pEntity.Column28;
			parameters[31].Value = pEntity.Column29;
			parameters[32].Value = pEntity.Column30;
        ...
        /// </summary>
        /// <param name="pEntity">实体实例</param>
        public void Update(CarStyleEngineEntity pEntity )
        {
        ...
        public void Delete(CarStyleEngineEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(CarStyleEngineEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [CarStyleEngine] set LastUpdateTime=@LastUpdateTime,LastUpdateBy=@LastUpdateBy,IsDelete=1 where ID=@ID;");
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(CarStyleEngineEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(CarStyleEngineEntity[] pEntities)
        { 
        ...
        public void Delete(object[] pIDs, IDbTransaction pTran) 
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [CarStyleEngine] set LastUpdateTime='"+DateTime.Now.ToString()+"',LastUpdateBy="+CurrentUserInfo.UserID+",IsDelete=1 where ID in (" + primaryKeys.ToString().Substring(0, primaryKeys.ToString().Length - 1) + ");");
            //执行语句
            int result = 0;   
            if (pTran == null)
        ...
        /// <returns></returns>
        public CarStyleEngineEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [CarStyleEngine] where isdelete=0 ");
        ...
        /// <returns></returns>
        public PagedQueryResult<CarStyleEngineEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            pagedSql.AppendFormat(") as ___rn,* from [CarStyleEngine] where isdelete=0 ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [CarStyleEngine] where isdelete=0 ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
            ...
            //执行语句并返回结果
            PagedQueryResult<CarStyleEngineEntity> result = new PagedQueryResult<CarStyleEngineEntity>();
            List<CarStyleEngineEntity> list = new List<CarStyleEngineEntity>();
        ...
        public CarStyleEngineEntity[] QueryByEntity(CarStyleEngineEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<CarStyleEngineEntity> PagedQueryByEntity(CarStyleEngineEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(CarStyleEngineEntity pQueryEntity)
        { 
            //获取非空属性数量
            ...
            if (pQueryEntity.Column26!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "Column26", Value = pQueryEntity.Column26 });
            if (pQueryEntity.Column27!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "Column27", Value = pQueryEntity.Column27 });
            if (pQueryEntity.Column28!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "Column28", Value = pQueryEntity.Column28 });
            if (pQueryEntity.Column29!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "Column29", Value = pQueryEntity.Column29 });
            if (pQueryEntity.Column30!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "Column30", Value = pQueryEntity.Column30 });
        ...
        protected void Load(SqlDataReader pReader, out CarStyleEngineEntity pInstance)
        {
            //将所有的数据从SqlDataReader中读取到Entity中
            pInstance = new CarStyleEngineEntity();
			...
			if (pReader["Column26"] != DBNull.Value)
			{
				pInstance.Column26 =  Convert.ToString(pReader["Column26"]);
			}
			if (pReader["Column27"] != DBNull.Value)
			{
				pInstance.Column27 =  Convert.ToString(pReader["Column27"]);
			}
			if (pReader["Column28"] != DBNull.Value)
			{
				pInstance.Column28 =  Convert.ToString(pReader["Column28"]);
			}
			if (pReader["Column29"] != DBNull.Value)
			{
				pInstance.Column29 =  Convert.ToString(pReader["Column29"]);
			}
			if (pReader["Column30"] != DBNull.Value)
			{
				pInstance.Column30 =  Convert.ToString(pReader["Column30"]);
			}
