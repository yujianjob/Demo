...
namespace Yunchee.Volkswagen.DataAccess
{
    ...
    public partial class BasicDataDAO : BaseDAO<BasicUserInfo>, ICRUDable<BasicDataEntity>, IQueryable<BasicDataEntity>
    {
        ...
        /// 构造函数 
        /// </summary>
        public BasicDataDAO(BasicUserInfo pUserInfo)
        ...
        public void Create(BasicDataEntity pEntity)
        {
        ...
        public void Create(BasicDataEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
            ...
            strSql.Append("[TypeCode],[TypeName],[Value],[Name],[SortIndex],[CreateBy],[CreateTime],[LastUpdateBy],[LastUpdateTime],[IsDelete])");
			...
			parameters[0].Value = pEntity.TypeCode;
			parameters[1].Value = pEntity.TypeName;
        ...
        public BasicDataEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
            ...
            sql.AppendFormat("select * from [BasicData] where ID='{0}' and IsDelete=0 ", id.ToString());
            //读取数据
            BasicDataEntity m = null;
        ...
        /// </summary>
        /// <returns></returns>
        public BasicDataEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [BasicData] where isdelete=0");
            //读取数据
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(BasicDataEntity pEntity , IDbTransaction pTran)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(BasicDataEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            ...
            strSql.Append("update [BasicData] set ");
                        if (pIsUpdateNullField || pEntity.TypeCode!=null)
        ...
        /// </summary>
        /// <param name="pEntity">实体实例</param>
        public void Update(BasicDataEntity pEntity )
        {
        ...
        public void Delete(BasicDataEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(BasicDataEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [BasicData] set LastUpdateTime=@LastUpdateTime,LastUpdateBy=@LastUpdateBy,IsDelete=1 where ID=@ID;");
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(BasicDataEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(BasicDataEntity[] pEntities)
        { 
        ...
        public void Delete(object[] pIDs, IDbTransaction pTran) 
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [BasicData] set LastUpdateTime='"+DateTime.Now.ToString()+"',LastUpdateBy="+CurrentUserInfo.UserID+",IsDelete=1 where ID in (" + primaryKeys.ToString().Substring(0, primaryKeys.ToString().Length - 1) + ");");
            //执行语句
            int result = 0;   
            if (pTran == null)
        ...
        /// <returns></returns>
        public BasicDataEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [BasicData] where isdelete=0 ");
        ...
        /// <returns></returns>
        public PagedQueryResult<BasicDataEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            pagedSql.AppendFormat(") as ___rn,* from [BasicData] where isdelete=0 ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [BasicData] where isdelete=0 ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
            ...
            //执行语句并返回结果
            PagedQueryResult<BasicDataEntity> result = new PagedQueryResult<BasicDataEntity>();
            List<BasicDataEntity> list = new List<BasicDataEntity>();
        ...
        public BasicDataEntity[] QueryByEntity(BasicDataEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<BasicDataEntity> PagedQueryByEntity(BasicDataEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(BasicDataEntity pQueryEntity)
        { 
            //获取非空属性数量
            List<EqualsCondition> lstWhereCondition = new List<EqualsCondition>();
            if (pQueryEntity.ID!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "ID", Value = pQueryEntity.ID });
            if (pQueryEntity.TypeCode!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "TypeCode", Value = pQueryEntity.TypeCode });
        ...
        protected void Load(SqlDataReader pReader, out BasicDataEntity pInstance)
        {
            //将所有的数据从SqlDataReader中读取到Entity中
            pInstance = new BasicDataEntity();
			...
			if (pReader["TypeCode"] != DBNull.Value)
			{
				pInstance.TypeCode =  Convert.ToString(pReader["TypeCode"]);
			}
