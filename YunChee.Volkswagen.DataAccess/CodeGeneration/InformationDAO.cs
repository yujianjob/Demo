...
namespace Yunchee.Volkswagen.DataAccess
{
    ...
    public partial class InformationDAO : BaseDAO<BasicUserInfo>, ICRUDable<InformationEntity>, IQueryable<InformationEntity>
    {
        ...
        /// 构造函数 
        /// </summary>
        public InformationDAO(BasicUserInfo pUserInfo)
        ...
        public void Create(InformationEntity pEntity)
        {
        ...
        public void Create(InformationEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
            ...
            strSql.Append("[InformationTypeID],[Title],[Description],[PictureUrl],[Content],[SortIndex],[Remark],[ClientID],[CreateBy],[CreateTime],[LastUpdateBy],[LastUpdateTime],[IsDelete])");
            ...
            {
					new SqlParameter("@InformationTypeID",SqlDbType.Int),
			...
			parameters[0].Value = pEntity.InformationTypeID;
			parameters[1].Value = pEntity.Title;
			parameters[2].Value = pEntity.Description;
			parameters[3].Value = pEntity.PictureUrl;
        ...
        public InformationEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
            ...
            sql.AppendFormat("select * from [Information] where ID='{0}' and IsDelete=0 ", id.ToString());
            //读取数据
            InformationEntity m = null;
        ...
        /// </summary>
        /// <returns></returns>
        public InformationEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [Information] where isdelete=0");
            //读取数据
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(InformationEntity pEntity , IDbTransaction pTran)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(InformationEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            ...
            strSql.Append("update [Information] set ");
                        if (pIsUpdateNullField || pEntity.InformationTypeID!=null)
        ...
        /// </summary>
        /// <param name="pEntity">实体实例</param>
        public void Update(InformationEntity pEntity )
        {
        ...
        public void Delete(InformationEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(InformationEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [Information] set LastUpdateTime=@LastUpdateTime,LastUpdateBy=@LastUpdateBy,IsDelete=1 where ID=@ID;");
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(InformationEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(InformationEntity[] pEntities)
        { 
        ...
        public void Delete(object[] pIDs, IDbTransaction pTran) 
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [Information] set LastUpdateTime='"+DateTime.Now.ToString()+"',LastUpdateBy="+CurrentUserInfo.UserID+",IsDelete=1 where ID in (" + primaryKeys.ToString().Substring(0, primaryKeys.ToString().Length - 1) + ");");
            //执行语句
            int result = 0;   
            if (pTran == null)
        ...
        /// <returns></returns>
        public InformationEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [Information] where isdelete=0 ");
        ...
        /// <returns></returns>
        public PagedQueryResult<InformationEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            pagedSql.AppendFormat(") as ___rn,* from [Information] where isdelete=0 ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [Information] where isdelete=0 ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
            ...
            //执行语句并返回结果
            PagedQueryResult<InformationEntity> result = new PagedQueryResult<InformationEntity>();
            List<InformationEntity> list = new List<InformationEntity>();
        ...
        public InformationEntity[] QueryByEntity(InformationEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<InformationEntity> PagedQueryByEntity(InformationEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(InformationEntity pQueryEntity)
        { 
            //获取非空属性数量
            List<EqualsCondition> lstWhereCondition = new List<EqualsCondition>();
            if (pQueryEntity.ID!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "ID", Value = pQueryEntity.ID });
            if (pQueryEntity.InformationTypeID!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "InformationTypeID", Value = pQueryEntity.InformationTypeID });
        ...
        protected void Load(SqlDataReader pReader, out InformationEntity pInstance)
        {
            //将所有的数据从SqlDataReader中读取到Entity中
            pInstance = new InformationEntity();
			...
			if (pReader["InformationTypeID"] != DBNull.Value)
			{
				pInstance.InformationTypeID =   Convert.ToInt32(pReader["InformationTypeID"]);
			}
