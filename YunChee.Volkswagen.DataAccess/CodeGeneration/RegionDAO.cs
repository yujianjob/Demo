...
namespace Yunchee.Volkswagen.DataAccess
{
    ...
    public partial class RegionDAO : BaseDAO<BasicUserInfo>, ICRUDable<RegionEntity>, IQueryable<RegionEntity>
    {
        ...
        /// 构造函数 
        /// </summary>
        public RegionDAO(BasicUserInfo pUserInfo)
        ...
        public void Create(RegionEntity pEntity)
        {
        ...
        public void Create(RegionEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
            ...
            strSql.Append("[Code],[Name],[ParentID],[AreaCode],[AreaLevel],[CreateBy],[CreateTime],[LastUpdateBy],[LastUpdateTime],[IsDelete])");
			...
			parameters[3].Value = pEntity.AreaCode;
			parameters[4].Value = pEntity.AreaLevel;
        ...
        public RegionEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
            ...
            sql.AppendFormat("select * from [Region] where ID='{0}' and IsDelete=0 ", id.ToString());
            //读取数据
            RegionEntity m = null;
        ...
        /// </summary>
        /// <returns></returns>
        public RegionEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [Region] where isdelete=0");
            //读取数据
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(RegionEntity pEntity , IDbTransaction pTran)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(RegionEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            ...
            if (pIsUpdateNullField || pEntity.AreaLevel!=null)
        ...
        /// </summary>
        /// <param name="pEntity">实体实例</param>
        public void Update(RegionEntity pEntity )
        {
        ...
        public void Delete(RegionEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(RegionEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [Region] set LastUpdateTime=@LastUpdateTime,LastUpdateBy=@LastUpdateBy,IsDelete=1 where ID=@ID;");
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(RegionEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(RegionEntity[] pEntities)
        { 
        ...
        public void Delete(object[] pIDs, IDbTransaction pTran) 
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [Region] set LastUpdateTime='"+DateTime.Now.ToString()+"',LastUpdateBy="+CurrentUserInfo.UserID+",IsDelete=1 where ID in (" + primaryKeys.ToString().Substring(0, primaryKeys.ToString().Length - 1) + ");");
            //执行语句
            int result = 0;   
            if (pTran == null)
        ...
        /// <returns></returns>
        public RegionEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [Region] where isdelete=0 ");
        ...
        /// <returns></returns>
        public PagedQueryResult<RegionEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            pagedSql.AppendFormat(") as ___rn,* from [Region] where isdelete=0 ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [Region] where isdelete=0 ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
            ...
            //执行语句并返回结果
            PagedQueryResult<RegionEntity> result = new PagedQueryResult<RegionEntity>();
            List<RegionEntity> list = new List<RegionEntity>();
        ...
        public RegionEntity[] QueryByEntity(RegionEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<RegionEntity> PagedQueryByEntity(RegionEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(RegionEntity pQueryEntity)
        { 
            //获取非空属性数量
            ...
            if (pQueryEntity.AreaLevel!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "AreaLevel", Value = pQueryEntity.AreaLevel });
        ...
        protected void Load(SqlDataReader pReader, out RegionEntity pInstance)
        {
            //将所有的数据从SqlDataReader中读取到Entity中
            pInstance = new RegionEntity();
			...
			if (pReader["AreaLevel"] != DBNull.Value)
			{
				pInstance.AreaLevel =   Convert.ToInt32(pReader["AreaLevel"]);
			}
