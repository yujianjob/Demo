...
namespace Yunchee.Volkswagen.DataAccess
{
    ...
    public partial class EventGameMappingDAO : BaseDAO<BasicUserInfo>, ICRUDable<EventGameMappingEntity>, IQueryable<EventGameMappingEntity>
    {
        ...
        /// 构造函数 
        /// </summary>
        public EventGameMappingDAO(BasicUserInfo pUserInfo)
        ...
        public void Create(EventGameMappingEntity pEntity)
        {
        ...
        public void Create(EventGameMappingEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
            ...
            strSql.Append("insert into [EventGameMapping](");
            strSql.Append("[EventID],[GameID],[ImageUrl],[GameName],[GameDescription],[GameRule],[InitialTime],[IconUrl],[ShareTitle],[ShareContent],[RedeemCodeConfig],[CreateBy],[CreateTime],[LastUpdateBy],[LastUpdateTime],[IsDelete])");
            ...
            SqlParameter[] parameters = 
            {
					...
					new SqlParameter("@RedeemCodeConfig",SqlDbType.NVarChar),
			...
			parameters[10].Value = pEntity.RedeemCodeConfig;
        ...
        public EventGameMappingEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
            ...
            sql.AppendFormat("select * from [EventGameMapping] where ID='{0}' and IsDelete=0 ", id.ToString());
            //读取数据
            EventGameMappingEntity m = null;
        ...
        /// </summary>
        /// <returns></returns>
        public EventGameMappingEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [EventGameMapping] where isdelete=0");
            //读取数据
            List<EventGameMappingEntity> list = new List<EventGameMappingEntity>();
            using (SqlDataReader rdr = this.SQLHelper.ExecuteReader(sql.ToString()))
            {
                while (rdr.Read())
                {
                    EventGameMappingEntity m;
                    this.Load(rdr, out m);
                    list.Add(m);
                }
            }
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(EventGameMappingEntity pEntity , IDbTransaction pTran)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(EventGameMappingEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            ...
            //组织参数化SQL
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [EventGameMapping] set ");
            ...
            if (pIsUpdateNullField || pEntity.RedeemCodeConfig!=null)
                strSql.Append( "[RedeemCodeConfig]=@RedeemCodeConfig,");
        ...
        /// </summary>
        /// <param name="pEntity">实体实例</param>
        public void Update(EventGameMappingEntity pEntity )
        {
        ...
        public void Delete(EventGameMappingEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(EventGameMappingEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [EventGameMapping] set LastUpdateTime=@LastUpdateTime,LastUpdateBy=@LastUpdateBy,IsDelete=1 where ID=@ID;");
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(EventGameMappingEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(EventGameMappingEntity[] pEntities)
        { 
        ...
        public void Delete(object[] pIDs, IDbTransaction pTran) 
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [EventGameMapping] set LastUpdateTime='"+DateTime.Now.ToString()+"',LastUpdateBy="+CurrentUserInfo.UserID+",IsDelete=1 where ID in (" + primaryKeys.ToString().Substring(0, primaryKeys.ToString().Length - 1) + ");");
            //执行语句
            int result = 0;   
            if (pTran == null)
        ...
        /// <returns></returns>
        public EventGameMappingEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [EventGameMapping] where isdelete=0 ");
        ...
        /// <returns></returns>
        public PagedQueryResult<EventGameMappingEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            pagedSql.AppendFormat(") as ___rn,* from [EventGameMapping] where isdelete=0 ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [EventGameMapping] where isdelete=0 ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
            ...
            //执行语句并返回结果
            PagedQueryResult<EventGameMappingEntity> result = new PagedQueryResult<EventGameMappingEntity>();
            List<EventGameMappingEntity> list = new List<EventGameMappingEntity>();
        ...
        public EventGameMappingEntity[] QueryByEntity(EventGameMappingEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<EventGameMappingEntity> PagedQueryByEntity(EventGameMappingEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(EventGameMappingEntity pQueryEntity)
        { 
            //获取非空属性数量
            ...
            if (pQueryEntity.RedeemCodeConfig!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "RedeemCodeConfig", Value = pQueryEntity.RedeemCodeConfig });
        ...
        protected void Load(SqlDataReader pReader, out EventGameMappingEntity pInstance)
        {
            //将所有的数据从SqlDataReader中读取到Entity中
            pInstance = new EventGameMappingEntity();
			...
			if (pReader["RedeemCodeConfig"] != DBNull.Value)
			{
				pInstance.RedeemCodeConfig =  Convert.ToString(pReader["RedeemCodeConfig"]);
			}
