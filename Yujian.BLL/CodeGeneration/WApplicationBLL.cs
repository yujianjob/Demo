...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class WApplicationBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private WApplicationDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WApplicationBLL(BasicUserInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new WApplicationDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
