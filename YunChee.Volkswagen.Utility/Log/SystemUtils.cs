...
namespace Yunchee.Volkswagen.Utility
{
    ...
    public static class SystemUtils
    {
        ...
        private static readonly string[] SKIPPED_METHOD_FULL_NAMES = new string[] { 
            "Yunchee.Volkswagen.Utility.SystemUtils.GetCurrentStackTraces"
            ,"Yunchee.Volkswagen.Utility.SystemUtils.GetStackTracesFrom"
            ,"Yunchee.Volkswagen.Utility.Log.DatabaseLogInfo..ctor"
            ,"Yunchee.Volkswagen.Utility.Log.DebugLogInfo..ctor"
            ,"Yunchee.Volkswagen.Utility.Log.ExceptionLogInfo..ctor"
        };
            ...
            if (pStackFrames != null && pStackFrames.Length > 0)
            {
                for (int i = pStackFrames.Length - 1; i >= 0; i--)
                {
                    ...
                    if (classType != null)
                    {
                        ...
                        if (className.StartsWith("Yujian."))
                        {
                            return i;
                        }
                    }
