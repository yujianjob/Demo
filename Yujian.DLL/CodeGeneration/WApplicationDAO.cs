...
namespace YuJian.WeiXin.DataAccess
{
    ...
    public partial class WApplicationDAO : BaseDAO<BasicUserInfo>, ICRUDable<WApplicationEntity>, IQueryable<WApplicationEntity>
    {
        ...
        public void Create(WApplicationEntity pEntity, IDbTransaction pTran)
        {
            ...
            strSql.Append("[Name],[Type],[WeixinID],[WeixinNumber],[DevelopUrl],[DevelopToken],[AppID],[AppSecret],[LoginName],[LoginPassword],[OAuthUrl],[AccessToken],[ExpirationTime],[CreateBy],[CreateTime],[LastUpdateBy],[LastUpdateTime],[IsDelete])");
